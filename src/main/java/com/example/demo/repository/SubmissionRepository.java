...
public interface SubmissionRepository extends JpaRepository<Submission, Long> {
    ...
    Optional<List<Submission>> findAllByConditions(@Param("user") User user, @Param("contestProblem") ContestProblem contestProblem, @Param("status") String status, Pageable pageable);
}
